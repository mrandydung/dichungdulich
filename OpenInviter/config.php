<?php
	$openinviter_settings=array(
		"username"=>"hungn111",
		"private_key"=>"dae3175d72d80b6b6941afb74a8a2a58",
		"cookie_path"=> dirname(__FILE__).'/tmp',
		"message_body"=>"You are invited to hungn.vn", // hungn.vn is the website on your account. If wrong, please update your account at OpenInviter.com
		"message_subject"=>" is inviting you to hungn.vn", // hungn.vn is the website on your account. If wrong, please update your account at OpenInviter.com
