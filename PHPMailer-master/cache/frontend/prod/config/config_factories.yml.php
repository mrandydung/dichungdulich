...
// date: 2015/08/19 09:48:00
  ...
  'cache_dir' => '/Volumes/Backup/project/dichungdulich/cache/frontend/prod/i18n',
  'lifetime' => 31556926,
  ...
  $class = sfConfig::get('sf_factory_routing', 'sfPatternRouting');
      $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/Volumes/Backup/project/dichungdulich/cache/frontend/prod/config/routing',
  'lifetime' => 31556926,
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('zend_front'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/Volumes/Backup/project/dichungdulich/cache/frontend/prod/template',
  'lifetime' => 86400,
