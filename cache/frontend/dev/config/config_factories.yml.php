...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/Volumes/DATA/project/dichungdulich/log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/Volumes/DATA/project/dichungdulich/cache/frontend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/Volumes/DATA/project/dichungdulich/apps/frontend/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'sfPatternRouting');
      $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/Volumes/DATA/project/dichungdulich/cache/frontend/dev/config/routing',
  'lifetime' => 31556926,
  'prefix' => '/Volumes/DATA/project/dichungdulich/apps/frontend',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('zend_front'),
), sfConfig::get('sf_factory_storage_parameters', array (
  'session_name' => 'zend_front',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/Volumes/DATA/project/dichungdulich/cache/frontend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/Volumes/DATA/project/dichungdulich/apps/frontend/template',
)));
