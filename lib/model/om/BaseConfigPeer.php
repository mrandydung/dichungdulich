...
abstract class BaseConfigPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Code', 'Val', ),
		BasePeer::TYPE_COLNAME => array (ConfigPeer::ID, ConfigPeer::CODE, ConfigPeer::VAL, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'code', 'val', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Code' => 1, 'Val' => 2, ),
		BasePeer::TYPE_COLNAME => array (ConfigPeer::ID => 0, ConfigPeer::CODE => 1, ConfigPeer::VAL => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'code' => 1, 'val' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ConfigPeer::CODE);

		$criteria->addSelectColumn(ConfigPeer::VAL);

	}

	const COUNT = 'COUNT(config.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT config.ID)';
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(ConfigPeer::ID, $criteria->remove(ConfigPeer::ID), $comparison);
