...
abstract class BaseMessage extends BaseObject  implements Persistent {
	...
	public function setUserSend($v)
	{
		...
		if ($this->user_send !== $v) {
			$this->user_send = $v;
			$this->modifiedColumns[] = MessagePeer::USER_SEND;
		}
	...
	public function setUserReceiver($v)
	{
		...
		if ($this->user_receiver !== $v) {
			...
			$this->modifiedColumns[] = MessagePeer::USER_RECEIVER;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = MessagePeer::DESCRIPTION;
		}
	...
	public function setDetail($v)
	{
		...
		if ($this->detail !== $v) {
			$this->detail = $v;
			$this->modifiedColumns[] = MessagePeer::DETAIL;
		}
	...
	public function setReaded($v)
	{
		...
		if ($this->readed !== $v || $v === false) {
			$this->readed = $v;
			$this->modifiedColumns[] = MessagePeer::READED;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MessagePeer::USER_SEND)) $criteria->add(MessagePeer::USER_SEND, $this->user_send);
		if ($this->isColumnModified(MessagePeer::USER_RECEIVER)) $criteria->add(MessagePeer::USER_RECEIVER, $this->user_receiver);
		if ($this->isColumnModified(MessagePeer::DESCRIPTION)) $criteria->add(MessagePeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(MessagePeer::DETAIL)) $criteria->add(MessagePeer::DETAIL, $this->detail);
		if ($this->isColumnModified(MessagePeer::READED)) $criteria->add(MessagePeer::READED, $this->readed);
