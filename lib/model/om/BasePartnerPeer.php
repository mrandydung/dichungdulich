...
abstract class BasePartnerPeer {
	...
	const TYPE_PARTNER = 'partner.TYPE_PARTNER';

	
	const NAME = 'partner.NAME';

	
	const NAME_EN = 'partner.NAME_EN';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'TypePartner', 'Name', 'NameEn', 'Link', 'Logo', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_COLNAME => array (PartnerPeer::ID, PartnerPeer::TYPE_PARTNER, PartnerPeer::NAME, PartnerPeer::NAME_EN, PartnerPeer::LINK, PartnerPeer::LOGO, PartnerPeer::CREATED_AT, PartnerPeer::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'type_partner', 'name', 'name_en', 'link', 'logo', 'created_at', 'updated_at', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'TypePartner' => 1, 'Name' => 2, 'NameEn' => 3, 'Link' => 4, 'Logo' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (PartnerPeer::ID => 0, PartnerPeer::TYPE_PARTNER => 1, PartnerPeer::NAME => 2, PartnerPeer::NAME_EN => 3, PartnerPeer::LINK => 4, PartnerPeer::LOGO => 5, PartnerPeer::CREATED_AT => 6, PartnerPeer::UPDATED_AT => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'type_partner' => 1, 'name' => 2, 'name_en' => 3, 'link' => 4, 'logo' => 5, 'created_at' => 6, 'updated_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PartnerPeer::TYPE_PARTNER);

		$criteria->addSelectColumn(PartnerPeer::NAME);

		$criteria->addSelectColumn(PartnerPeer::NAME_EN);

		$criteria->addSelectColumn(PartnerPeer::LINK);

		$criteria->addSelectColumn(PartnerPeer::LOGO);
