...
abstract class BasePaymentType extends BaseObject  implements Persistent {
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = PaymentTypePeer::NAME;
		}
	...
	public function setNameEn($v)
	{
		...
		if ($this->name_en !== $v) {
			$this->name_en = $v;
			$this->modifiedColumns[] = PaymentTypePeer::NAME_EN;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PaymentTypePeer::NAME)) $criteria->add(PaymentTypePeer::NAME, $this->name);
		if ($this->isColumnModified(PaymentTypePeer::NAME_EN)) $criteria->add(PaymentTypePeer::NAME_EN, $this->name_en);
		...
		if ($this->collTourDetails === null) {
			if ($this->isNew()) {
			   $this->collTourDetails = array();
				...
				$criteria->add(TourDetailPeer::PAYMENT_TYPE_ID, $this->getId());
