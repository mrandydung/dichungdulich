...
abstract class BasePaymentTypePeer {
	...
	const ID = 'payment_type.ID';

	
	const NAME = 'payment_type.NAME';

	
	const NAME_EN = 'payment_type.NAME_EN';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (PaymentTypePeer::ID, PaymentTypePeer::NAME, PaymentTypePeer::NAME_EN, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (PaymentTypePeer::ID => 0, PaymentTypePeer::NAME => 1, PaymentTypePeer::NAME_EN => 2, ),
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PaymentTypePeer::NAME);

		$criteria->addSelectColumn(PaymentTypePeer::NAME_EN);

	}

	const COUNT = 'COUNT(payment_type.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT payment_type.ID)';
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(PaymentTypePeer::ID); 
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof PaymentType) {
