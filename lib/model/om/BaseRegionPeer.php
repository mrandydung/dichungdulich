...
abstract class BaseRegionPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (RegionPeer::ID, RegionPeer::NAME, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (RegionPeer::ID => 0, RegionPeer::NAME => 1, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.map.RegionMapBuilder');
	}
	
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = RegionPeer::getTableMap();
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(RegionPeer::NAME);

	}

	const COUNT = 'COUNT(region.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT region.ID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(RegionPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(RegionPeer::COUNT);
		}
		...
		$rs = RegionPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	{
		return RegionPeer::populateObjects(RegionPeer::doSelectRS($criteria, $con));
	}
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof Region) {
...
if (Propel::isInit()) {
			try {
		BaseRegionPeer::getMapBuilder();
	} catch (Exception $e) {
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
	}
} else {
			Propel::registerMapBuilder('lib.model.map.RegionMapBuilder');
}
