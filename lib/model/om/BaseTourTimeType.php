...
abstract class BaseTourTimeType extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = TourTimeTypePeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = TourTimeTypePeer::NAME;
		}
	...
	public function setNameEn($v)
	{
		...
		if ($this->name_en !== $v) {
			$this->name_en = $v;
			$this->modifiedColumns[] = TourTimeTypePeer::NAME_EN;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating TourTimeType object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			TourTimeTypePeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TourTimeTypePeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += TourTimeTypePeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TourTimeTypePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TourTimeTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TourTimeTypePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TourTimeTypePeer::ID)) $criteria->add(TourTimeTypePeer::ID, $this->id);
		if ($this->isColumnModified(TourTimeTypePeer::NAME)) $criteria->add(TourTimeTypePeer::NAME, $this->name);
		if ($this->isColumnModified(TourTimeTypePeer::NAME_EN)) $criteria->add(TourTimeTypePeer::NAME_EN, $this->name_en);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TourTimeTypePeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new TourTimeTypePeer();
		}
		return self::$peer;
	}
		...
		if ($this->collTourDetails === null) {
			if ($this->isNew()) {
			   $this->collTourDetails = array();
				...
				$criteria->add(TourDetailPeer::TIME_TYPE_ID, $this->getId());
