...
abstract class BaseTypePricingService extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = TypePricingServicePeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = TypePricingServicePeer::NAME;
		}
	...
	public function setNameEn($v)
	{
		...
		if ($this->name_en !== $v) {
			$this->name_en = $v;
			$this->modifiedColumns[] = TypePricingServicePeer::NAME_EN;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating TypePricingService object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			TypePricingServicePeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TypePricingServicePeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += TypePricingServicePeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TypePricingServicePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TypePricingServicePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TypePricingServicePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TypePricingServicePeer::ID)) $criteria->add(TypePricingServicePeer::ID, $this->id);
		if ($this->isColumnModified(TypePricingServicePeer::NAME)) $criteria->add(TypePricingServicePeer::NAME, $this->name);
		if ($this->isColumnModified(TypePricingServicePeer::NAME_EN)) $criteria->add(TypePricingServicePeer::NAME_EN, $this->name_en);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TypePricingServicePeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new TypePricingServicePeer();
		}
		return self::$peer;
	}
		...
		if ($this->collTourDetails === null) {
			if ($this->isNew()) {
			   $this->collTourDetails = array();
				...
				$criteria->add(TourDetailPeer::TYPE_PRICING_SERVICE_ID, $this->getId());
