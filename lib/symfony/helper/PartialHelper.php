...
function get_partial_class()
{
	$cls = 'sfPartialView';
	if(class_exists('sfTwigPartialView') && sfConfig::get('sf_app') != 'backend')
		$cls = 'sfTwigPartialView';
	return $cls;
}
/**
...
function get_component($moduleName, $componentName, $vars = array())
{
  ...
  $actionName = '_'.$componentName;
	...
	$cls = get_partial_class();
		
  $view = new $cls($context, $moduleName, $actionName, '');
