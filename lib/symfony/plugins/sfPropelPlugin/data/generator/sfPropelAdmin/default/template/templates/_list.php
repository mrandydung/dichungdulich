...
<?php endif; ?>
[?php slot('paging')?]
<tr><th  style="border-bottom: solid 1px;" colspan="<?php echo count($this->getColumns('list.display')) + ($this->getParameterValue('list.object_actions') ? 1 : 0) + ($this->getParameterValue('list.batch_actions') ? 1 : 0) ?>">
...
[?php echo format_number_choice('[0] no result|[1] 1 result|(1,+Inf] %1% kết quả', array('%1%' => $pager->getNbResults()), $pager->getNbResults()) ?]
</th></tr>

[?php end_slot()?]
<table cellspacing="0" class="sf_admin_list">
<thead>
[?php echo get_slot('paging')?]
