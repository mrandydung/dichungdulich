  jQuery(document).ready(function ($) {
        var options = {
            ...
            $PauseOnHover: 1,                               //[Optional] Whether to pause when mouse over if a slider is auto playing, 0 no pause, 1 pause for 
        ...
        function ScaleSlider() {
            ...
            if (bodyWidth)
                jssor_slider1.$SetScaleWidth(Math.min(bodyWidth, 990));
            else
