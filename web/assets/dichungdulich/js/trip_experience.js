...
$(document).ready(function(){
  ...
  $('#showmorethisresult').click(function(){
  	...
  	page = page + 1;
  	jQuery.ajax({ type: "POST",url: "/trip_experience/read_more_content",  dataType:"json",
  ...
  $('#select_filter_experience').change(function(){
    var select_filter_experience = $('#select_filter_experience').val();
    if(select_filter_experience == '1'){
      page = 1;
      $('#showmorethisresult').show();
      jQuery.ajax({ type: "POST",url: "/trip_experience/select_filter_experience",  dataType:"json",
