  ...
  $.extend($.facebox, {
											...
											<div class="popup"> \
												<table> \
													<tbody> \
														...
														<tr> \
															<td class="b"/> \
															<td class="body"> <div class="facebox_title"></div>\
																<div class="content">  \
																</div> \
																<div class="footer"> \
																	<span class="action"></span> \ <a href="#" class="close"> \
    ...
    reveal: function(data, klass) {
      ...
      if (klass) $('#facebox .content').addClass(klass)
			...
			{
				$('#facebox .content').css('width', $.facebox.settings.width);
			}
    ...
    function clickHandler() {
      ...
      if (klass) klass = klass[1];
			 ...
			 if(!text)
			 {
				...
				$('#facebox .facebox_title').html(text);
