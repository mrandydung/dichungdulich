    ...
    $.alerts = {
                ...
                case 'form':
                    ...
                    $("#popup_ok").click(function () {
                        ...
                        if (notSubmit) {
                            ...
                            var header = {};
                            $('#popup_message form').find('input[type="text"], input[type="hidden"], input[type="password"], select, input:checked, textarea, button').each(function () {
        ...
        _reposition: function () {
            ...
            setTimeout(function () {
                ...
                if (wh < 400) {
                    if ($("#popup_container").outerHeight() > 400) {
                        $('#popup_message').css({height: (wh - 100) + 'px'});
                    }
                }
                else {
